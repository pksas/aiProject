...
- [x] Поиск продукта и проверка результатов
- [x] Поиск гирлянд и проверка всех заголовков
- [x] Добавление товара в корзину
- [x] Добавление конкретного товара в корзину через поиск

### Api
- [x] Проверка успешного ответа (Status Code 200)
- [x] Проверка обязательных полей в ответе
- [x] Тестирование десериализации ответа
- [x] Проверка успешности получения списка объектов NEO
